...
public class GameController : MonoBehaviour {
	...
	public string[] levelsChooser = new string[] {"Level01", "Level02", "Level03", "Level04"};
	...
	public void nextRound() {
		...
		int randomLevel = Random.Range(0,levelsChooser.Length);
		Debug.Log ("Number of levels are " + levelsChooser.Length);
		// load next level
		Application.LoadLevel(levelsChooser[randomLevel]);
